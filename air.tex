...
water of the AIR every hour. In each time step, the model uses the AIR surface area, energy balance and mass
...
change as shown in \ref{fig:shape}. $M_{ice}$ is the mass of the AIR and $\Delta M_{ice} = M_{ice}^{i-1} -
	M_{ice}^{i-2}$.
