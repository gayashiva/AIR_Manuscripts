...
bottom of the surface layer. Therefore, additional measurements of the bulk ($T_{bulk}$) and the surface
temperature ($T_{ice}$) of the AIR could have better constrained the range of the surface layer thickness
parameter.
...
high water losses were caused by the fountain wastewater in both the AIRs. Therefore, AIRs waste water mostly
...
melting rates. Hence, AIRs need to be inculcated in the water resource management strategy particularly in dry
and cold mountain regions such as in Central Asia or the Andes with few other sustainable and affordable
alternatives.
...
similar to the ones used on glaciers world over, we believe it's performance should be similar in any other
location.  
