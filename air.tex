...
\begin{abstract}
	...
	losses for all the AIRs were more than three quarters of the total fountain discharge due to high fountain water runoff. Drier
	...
	technology could provide a relatively cheap and sustainable strategy to mitigate climate change induced water
	stress.
...
three AIRs, which have a relatively complete dataset. As shown in Table \ref{tab:Observations}, two of them were
...
has a good (TODO How much?) correlation with sites in Switzerland \citep{Scherrer_2020}. The ERA5 grid point
