...
and \ref{eq:mcone}. Having calculated all of the other mass components, the fountain wastewater generated every
...
mostly during the accumulation period. The freezing rate of the IN21 AIR was less than $20 \, l\,min^{-1}$ for more
...
\begin{itemize}
  ...
  \item Water losses were high ($>77\,\%$) mostly due to fountain wastewater for all the AIRs. Vapour losses
    were insignificant ($<2\,\%$) in comparison. However, significant reduction in water loss is possible
