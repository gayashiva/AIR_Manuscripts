...
across its surface area with an invariant slope $s_{cone} = \frac{h_{ice}}{r_{ice}}$ .  During these time steps,
...
\begin{equation} TC_{ice}=\frac{\Delta M_{ice}}{\rho_{water}* A} \end{equation}
...
(Reference). These foehn events produced meltwater at the Swiss location sites even during the accumulation
periods (e.g.  day 17). Both the sensible and the latent heat significantly increase in magnitude in the
ablation period due to a higher temperature gradient between the AIR surface and the atmosphere.
...
radiation in the ablation period compared to the accumulation period. Albedo, on the other hand, only varied for
the Swiss location because there was no precipitation for the IN21 site.
