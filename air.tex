...
frozen, melted, evaporated and runoff. Sensitivity and uncertainty analysis were performed to identify the most
...
\begin{equation} \textit{SE} = \frac{M_{runoff}+M_{sub}}{(M_F+M_{ppt}+M_{dep})} \cdot 100 \end{equation}
...
We compare the model performance between the AIRs by using the relative error produced in maximum AIR ice volume
due to the RMSE with the UAV ice volume observations. This judgement depends on the number of UAV observations
which was much higher for the IN21 and CH21 AIR compared to the CH20 AIR. Hence, there could be some temporal bias
involved in the RMSE result of the CH20 AIR. Regardless, we find that the relative error of the model in estimating
the maximum ice volume was 10 \%, 8\% and 11 \% for the IN21, CH21 and CH20 AIR respectively.
...
fountain water losses in both the AIRs . However, sublimation losses are significant in the Indian location (4\%) but
they result in more ice mass through their energy flux.
