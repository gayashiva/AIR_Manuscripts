...
\begin{subequations}
	\begin{align}
		\frac{\Delta M_{F}}{\Delta t} & = \left\{ \begin{array}{ll} 60/\rho_w \cdot d_F/\Delta t
...
other eight parameters. Since in our case the total order sensitivity of $\Delta x$ and the rest of the
...
$T_{ice}, T_{bulk}$ and $\Delta x$. For example, all three AIRs studied here had similar minimum modelled
surface and bulk temperature around $-24\,\degree C$ and $-3\,\degree C$ respectively. Compared to $T_{bulk}$,
the value of $T_{ice}$ is not too high in accordance with (a) and also not too low in accordance with (b). The
...
high water losses were caused by the fountain wastewater for both AIRs. Therefore, AIRs waste water mostly
