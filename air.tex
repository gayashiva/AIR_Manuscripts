...
\begin{table}
	...
	\begin{tabular}{@{}|llllll|@{}}
		...
		\multicolumn{1}{|l|}{\multirow{5}{*}{\rotatebox[origin=c]{90}{IN21}}}
		                       & 1            & Jan 18, 2021  & 79 $m^{3}$      & 5.8 $m$
		                       & 204 $m^{2}$                                                                      \\
		\multicolumn{1}{|l|}{} & 2            & Feb 27, 2021  & 637 $m^{3}$     & 10.2 $m$
		                       & 686 $m^{2}$                                                                      \\
		\multicolumn{1}{|l|}{} & 3            & Mar 3, 2021   & 740 $m^{3}$     & 11.3 $m$
		                       & 675 $m^{2}$                                                                      \\
		\multicolumn{1}{|l|}{} & 4            & Mar 15, 2021  & 669 $m^{3}$     & 10.2 $m$
		                       & 700 $m^{2}$                                                                      \\
		\multicolumn{1}{|l|}{} & 5            & Mar 26, 2021  & 706 $m^{3}$     & 11.1 $m$
		                       & 733 $m^{2}$
		\\\midrule
		\multicolumn{1}{|l|}{\multirow{9}{*}{\rotatebox[origin=c]{90}{CH21}}}
		                       & 1            & Nov 22, 2020  & 13 $m^{3}$      & 5.4 $m$
		                       & 136$m^{2}$                                                                       \\
		\multicolumn{1}{|l|}{} & 2            & Dec 2, 2021   & 26 $m^{3}$      & 5.7 $m$
		                       & 118$m^{2}$                                                                       \\
		\multicolumn{1}{|l|}{} & 3            & Dec 30, 2021  & 43 $m^{3}$      & 7.5 $m$
		                       & 189$m^{2}$                                                                       \\
		...
		\multicolumn{1}{|l|}{} & 8            & Apr 24, 2021  & 37 $m^{3}$      & 4.7 $m$
		                       & 80 $m^{2}$                                                                       \\
		\multicolumn{1}{|l|}{} & 9            & May 10, 2021  & 13 $m^{3}$      & N.A.
		                       & N.A.
		\\\midrule
		\multicolumn{1}{|l|}{\multirow{3}{*}{\rotatebox[origin=c]{90}{CH20}}}
		                       & 1            & Jan 3, 2021   & 24 $m^{3}$      & 6.7 $m$
		                       & 170 $m^{2}$                                                                      \\
		\multicolumn{1}{|l|}{} & 2            & Jan 24, 2021  & 59 $m^{3}$      & 7.7 $m$
		                       & 228 $m^{2}$                                                                      \\
		\multicolumn{1}{|l|}{} & 3            & Apr 6, 2021   & 24 $m^{3}$      & 6.7 $m$
		                       & N.A.
		\\\midrule
	\end{tabular}
...
sensitive parameters among the best 10 \% runs from a total of 6875 model runs for each AIR.
...
In general, the sensitive parameters dont exhibit significant preference to any value in their ranges except the
surface layer thickness and the area correction factor. IN21 AIR exhibited a strong preference for a $\Delta x$ of
$20\,mm$. Since, this factor was a model hyperparameter common to all the AIRs, this was set as the calibrated
value . Both the AIRs prefer an area correction factor of 1.3, so it was set as the calibrated value. The rest of
the parameters were calibrated to their median values.
