...
\begin{abstract}
	...
	use AIRs for water storage. This study attempts to quantify the influence of construction location by comparing
	the evolution of AIRs built in Ladakh and two other AIRs built in Guttannen, Switzerland through a surface energy
	balance model. AIR surface processes were quantified using meteorological data in conjunction with fountain
	...
	favourable compared to the Swiss primarily because of much higher sublimation rates. However, the storage
...
\begin{equation}
	\begin{split} p_{v,a}&=6.107 \cdot 10^{(7.5 \cdot T_a / (T_a + 237.3))} \cdot \frac{RH}{100}\\
		p_{v,ice}&=(1.0016 + 3.15\cdot10^{-6}\cdot p_{a}-0.074\cdot p_{a}^{-1})\cdot(6.112 \cdot e^{(22.46 \cdot
					T_{ice} / (T_{ice} + 272.62))})
