...
radiation during the accumulation period were much lower than those of the Swiss location. This was mostly due
to lower mean winter temperature and less cloudiness. Moreover, the Indian location had a similar mean thickness
decay compared to the Swiss location, due to its latent fluxes acting against the sensible heat fluxes using the
sublimation process during the ablation period. This was not the case in the Swiss location, where deposition
process was favoured during the ablation period due to higher relative humidity and temperature.
