...
\begin{equation} (\frac{\Delta M_{ice} + \Delta M_{vapour} - \Delta M_{dpt}-\Delta M_{ppt}}{\Delta
        t}, \frac{\Delta M_{melt}}{\Delta t})  = \left\{ \begin{array}{ll} \frac{q_{freeze/melt} \cdot A }{L_f} \cdot (-1,1) &
        \textit{ if } q_{freeze/melt} \geq 0 \\ \frac{q_{freeze/melt} \cdot A }{L_f} \cdot (1,0) & \textit{ if } q_{freeze/melt} < 0 
\end{array} \right.
    \end{equation}
