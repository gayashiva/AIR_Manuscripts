...
\def\Authors{Suryanarayanan Balasubramanian\,$^{1*,3}$, Martin Hoelzle\,$^{1}$, Michael Lehning\,$^{2}$, Jordi Bolibar\,$^{4}$, Sonam Wangchuk\,$^{3}$, Johannes Oerlemans\,$^{4}$, and Felix Keller\,$^{5,6}$}
...
\begin{abstract}
	...
	the model achieved a high correlation ($r^2 > 0.9$) with the UAV ice volume observations and was able to estimate
	their ice volume with an RMSE $10 \, \pm \, 1 \, \%$ of their maximum ice volume for three AIRs in two construction
...
process. The higher sublimation at the Indian location not just increased the water loss but, more importantly,
increased the freezing energy and decreased the melting energy.
...
an RMSE less than $10 \, \pm \, 1 \, \%$ of the maximum ice volume for all the AIRs. The results suggest that drier and
colder locations in relatively cloud free regions like Ladakh are significantly more favourable. Water losses of
all the AIR are high but can be optimized significantly through optimization of the fountain.  The model
results indicate that more than 75\% of the fountain water is lost as runoff for all the AIRs.  Further experiments
are required to optimize the fountain to achieve much lower AIR water losses.
