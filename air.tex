...
independently if all the AIR meltwater and wastewater had been stored in a tank. But there were two
...
\subsection{Model application in a new location}

Ice volume estimates at any new location can be obtained from the model if the meteorological data and some
...
All the weather parameters can be assumed to have the median values of their ranges defined in Table
...
deposition process, thus decreasing the magnitude of net turbulent flux during the ablation period. This results
