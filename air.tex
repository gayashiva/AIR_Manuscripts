...
described in \citep{Garratt_1992}.The vapor pressures over air ($p_{v,a}$) and ice ($p_{v,ice}$) was obtained using the
...
where $p_{a}$ is the measured air pressure in [$hPa$].  \subsubsection{Fountain water heat flux
