...
simultaneously through deposition/sublimation processes. Indian AIR lost 4 \% of its mass input to sublimation
compared to the 1 \% for the Swiss AIR as the corresponding latent heat fluxes were an order of magnitude larger
(see Table \ref{tab:Observations}). This was primarily due to the difference in relative humidity between the
sites. This was expected since glaciers near the Indian location have been hypothesized to lose a significant
amount of mass through sublimation by \cite{azam_2018}. Throughout the life cycle of the Indian AIR, mass was lost
through sublimation but the corresponding energy flux was used to freeze much more ice since the heat of
vaporization is much larger than the heat of fusion.
