...
Freezing events can only occur, if fountain water is available and $T_{temp}$ is below $0\,\degree C$.
...
correction factor to be higher than that of CH21 AIR because the IN21 surface area represents the
...
just one UAV observation of the CH20 AIR volume (see Table \ref{tab:uav}). The RMSE of that UAV ice observation
...
freezing EBC, melt thickness corresponds to melting EBC available and the net thickness represents the total
