...
experiment duration, the total energy flux between the atmosphere and the Icestupa were almost balanced. Net shortwave
radiation (32 $Wm^{-2}$), sensible (9 $Wm^{-2}$) and latent heat flux (2 $Wm^{-2}$) with a mostly positive flux
towards the surface of the icestupa were compensated by the net longwave radiation (- 32 $Wm^{-2}$) and the melt energy
(-12 $Wm^{-2}$). The contributions of other fluxes were negligible in comparison.
...
mostly to the melt of the ice structure. Daily values of $q_{S}$ ranged from -15 to 26 $Wm^{-2}$. The mean of the
turbulent latent heat flux $q_{L}$ across model runtime was positive suggesting that it favoured
deposition/condensation over evaporation/sublimation.  Daily values of $q_{L}$ ranged from -10 to 14 $Wm^{-2}$.
Therefore, the Icestupa gained mass cumulatively from the atmosphere due to the deposition/condensation process.
Fountain water heat flux $q_{F}$ had a mean of zero as it was only nonzero during 1002 time steps or around 100 hours.
Daily values of $q_{F}$ ranged from -1 to 7 $Wm^{-2}$. The contribution of heat flux by conduction $q_{G}$ was also
minimal as it only varied between -7 to 8 $Wm^{-2}$ with a mean of 0 $Wm^{-2}$. The energy contributing to surface
...
considered period, $q_{LW}$ accounted for 32.5\% of overall energy turnover. The energy turnover is calculated as the
sum of energy fluxes in absolute values. $q_{SW}$ accounted for 31.5\%, followed by $q_{melt}$ (20\%), $q_{S}$ (9.8\%),
$q_{L}$ (3.2\%), $q_{G}$ (2\%), $q_{F}$ (0.2\%) and $q_{T}$ (0.4\%).
