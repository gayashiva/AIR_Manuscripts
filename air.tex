...
the water temperature were completely ignored in the model. During the CH21 experiment, snow formation was
observed indicating that the fountain water droplets have the potential to freeze before deposition on the AIR
surface. Moreover, $r_F$ also has significant temporal variance as can be observed in Table \ref{tab:uav}.
...
correlation of the fountain parameters amongst themselves and with the weather parameters. This will be
