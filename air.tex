...
% \begin{table} 
%     \centering
%     \caption{Free parameters in the model categorised as surface and fountain parameters. Initial
%         value (I) and uncertainty (U) .}
% \label{tab:parameters} 
%     
%     \begin{tabularx}{\linewidth}{ X l X l X l } 
%         \hline Surface Parameters & U & I & CH21 & IN21 & CH20 \\ 
%         \hline $\epsilon_{ice}$ & 0.949-0.993 & 0.97 & & &\\
%         $\alpha_{ice}$ & 0.01-0.35 & 0.15 & & &\\
...
%         Temperature threshold for precipitation & $T_{ppt}$ & 1 \degree C & $\pm$ $1\,\degree C$ & B + U: \citeauthor{FujitaAgeta_2000},\citeauthor{Zhou_2010}\\
%         Surface Roughness & $z_0$ & 1 $mm$ & $1-5\, mm$ & B: \citeauthor{pellicciotti_2005}; U: \citeauthor{BrockWillisSharp_2006}  \\
