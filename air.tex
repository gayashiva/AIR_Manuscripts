...
thickness rate as a measure to quantify the location influence. The net thickness rate ($TR_{ice}$) for any
AIR defined as:

\begin{equation} TR_{ice}=\frac{\Delta M_{ice}}{\rho_{water}* A} \end{equation}

Note that $TR_{ice}$ is similar to the "mass balance" of a glacier with units $m \, w.\, e.$ but it is not
...
\begin{table}
	...
	\begin{tabular}{@{}|llllll|@{}}
		...
		\multicolumn{1}{|l|}{} & Thickness rate                  & $TR_{ice}$      & $1 \pm 25$    & $-3 \pm 21$   &
		$mm \, w.\,e.$                                                                                                           \\
...
forcing($q_{T}$) and albedo forcing ($q_{SW}$). However, this influence is minimal compared to the influence
...
The difference in melting rate between IN21 and CH21 AIR was much smaller compared to the difference in their
corresponding  freezing rates (see Table \ref{tab:Observations}). This was because the smaller mean thickness
decay rate compensated for the higher surface area of the Indian location compared to the Swiss.

Thus, the more than three times higher mean surface area of the fountain and four times higher mean thickness
growth rate during the 2 times shorter accumulation period of the Indian location result in more than five times
