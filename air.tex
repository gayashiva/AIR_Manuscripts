...
\begin{abstract}
	...
	Reservoirs (AIRs) to augment their irrigation water supply. However, it is still unknown whether this water storage
	technology is viable anywhere else. This study attempts to quantify the influence of this construction location
	by comparing the evolution of AIRs built in Ladakh and two other AIRs built in Guttannen, Switzerland through a
	surface energy balance model. AIR surface processes were quantified using meteorological data in conjunction with
	...
	model calibration and validation purposes. The Indian location, with a maximum ice volume 5 times larger, was
	more favourable compared to the Swiss primarily because of much higher sublimation rates.  However, the storage
