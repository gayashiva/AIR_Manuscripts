...
Model calculations estimate that the Eispalast Icestupa stored about 5\% of the total water sprayed as ice. In addition,
...
scalar). The vapor pressures over air ($p_{v,a}$) and ice ($p_{v,ice}$) was obtained using the following formulation given in \cite{WMO_2018}:
