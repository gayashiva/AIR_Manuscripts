...
Considering AIRs as water reservoirs, we can quantify their water storage efficiency as follows:

\begin{equation} \textit{Storage Efficiency} = \frac{M_{water}+M_{ice}}{(M_F+M_{ppt}+M_{dep})} \cdot 100 \end{equation}
...
\subsubsection{Energy and mass balance calculation}
