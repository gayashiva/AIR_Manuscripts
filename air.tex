...
\begin{abstract}
	...
	\tiny
	\keyFont{ \section{Keywords:} icestupa, water storage, climate change adaptation, geoengineering, glaciology } %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
...
\begin{figure} \begin{center} \includegraphics[width=15 cm]{Figures/model_schematic.png} \end{center} \caption{Model
