...
thickness change as a measure to quantify the location influence. The net thickness change ($T_{ice}$) for any
AIR defined as:

\begin{equation} T_{ice}=\Delta M_{ice}/A \end{equation}

Note that $T_{ice}$ is similar to the "mass balance" of a glacier with units $m \, w.\, e.$ but it is not
