...
this analysis), discharge rate and spray radius were related through the trajectories of the water droplets. Therefore,
...
\subsubsection{Shape assumption}
 ...
 example, model the AIR shape assuming its cross section is a gaussian curve instead of a triangle. The second
 assumption could be improved if refreezing and melting events across the perimeter of the AIR are accounted
 for. But both these methodologies will involve inclusion of more model parameters.
