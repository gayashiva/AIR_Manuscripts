...
uncertainty determination required 32 simulations for each AIR. The prediction interval of the weather
parameters increase throughout the simulation period whereas the prediction interval fountain parameters only
increase during the accumulation period. 
