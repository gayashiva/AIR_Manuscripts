...
\title[Artificial Ice Reservoirs]{Influence of location on artificial ice reservoir (Icestupa)
	evolution }
...
to higher altitude and lower latitude. The lower mean winter temperature results in higher contribution of the
longwave radiation in the freezing energy flux and lower humidity results in latent heat increasing and decreasing
the freezing and melting energy respectively as shown in Fig. \ref{fig:MEB}. Hence, given AIRs with similar
fountain parameters, we expect locations with lower cloudiness, lower mean winter temperature and lower relative
humidity to be more favourable.
...
looked into in a follow up study.
...
is probably due to a combination of several factors and their interaction. Mean freezing rates were significantly
higher but mean melting rate was similar between the Indian and the Swiss location. This is because the mean
freezing energy and the surface area of the Indian location were significantly higher than that of the Swiss. Since
the mean freezing and melting energy was correlated more with the weather parameters and the surface area was
correlated more with the fountain parameters, the Indian AIR achieved a much higher ice volume due to a favourable
location and a better fountain.

The freezing and melting energy was favourable in Indian over the Swiss location primarily due to the sublimation
process. Contrary to expectation, the higher sublimation at the Indian location did not increase the water loss but
instead favoured ice formation by increasing the freezing energy and decreasing the melting energy.

The Indian fountain was more favourable than the Swiss due to its higher spray radius. This spray radius increased
the available surface area for both freeze and melt events but since the freezing energy was much higher than the
melting energy, the Indian location used this surface area to increase its freezing rate. The Swiss location could
not capitalize on the surface area since its freezing energy was lower than the melting energy.
...
required to optimize the fountain to achieve much lower AIR water losses.
