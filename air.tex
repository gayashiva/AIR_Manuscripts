...
the influence of different surface processes using Table \ref{tab:turnover}.
...
(sensible and latent) on the freezing and melting energies, we sum their respective energy turnover. The
radiation fluxes contribute 42 \% and -13 \% to the freezing and melting energies for the Indian location and 22
\% and -6 \%  to the Swiss location respectively.  Similarly, the turbulent fluxes at the Indian location
contribute -1 \% and 25 \% and at the Swiss location contribute -11 \% and 43\%  respectively. So the AIR
thickness growth rate was driven by the net radiation fluxes and the AIR thickness decay rate was driven by the net
turbulent fluxes.
