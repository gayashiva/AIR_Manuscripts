...
the modelled conical surface; $V_{cone}$ is the volume and $T_{cone}$ is the AIR net surface normal thickness
rate as shown in \ref{fig:shape}.
...
the volume is parameterised using Eqn. \ref{eq:V} as:
...
\begin{equation} T_{cone}=\frac{\Delta M_{ice}}{\rho_{water}* A_{cone}} \end{equation}
