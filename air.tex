...
AIR where in reality the two AIRs merged leading to a drastically different shape evolution compared to our model.
...
deposition process, thus decreasing the magnitude of net turbulent flux during the ablation period. This
