...
\citep{ERA5_2020}. The ERA5 grid point chosen(Latitude 46.640, Longitude 7.240) for the Schwarzsee site was around 9 km
away from the actual site. So in order to fit the corresponding variables in the Schwarzee dataset, several
modifications were necessary. First, the hourly ERA5 data were linearly interpolated to the 5 minute data frequency of
the Schwarzsee AWS. Then, selected variables of the ERA5 dataset were matched with Schwarzsee variables as follows: 

\begin{itemize} 
  \item Schwarzsee Air temperature: This variable correlated well() with 2m temperature of ERA5.
  \item Schwarzsee Air Pressure: This variable correlated well() with surface pressure of ERA5.
  \item Schwarzsee Wind Speed: This variable correlated well() with 10m wind speed of ERA5.
  \item Schwarzsee Precipitation: Since no precipitation measurements were made in Schwarzsee, the nearby Plaffein
    weather station was used for precipitation data instead as shown in \ref{fig:input}
  \item Schwarzsee Relative Humidity: This variable was derived from the 2m dewpoint temperature and 2m temperature of ERA5 using
