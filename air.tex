...
\begin{abstract}
	...
	AIRs were built for model calibration and validation purposes.  The maximum ice volume of the Indian AIR was 5
	times larger compared to the Swiss because of its favourable location (much lower humidity) and better fountain
	(higher spray radius).  However, the storage efficiency of the Indian AIR (19 \%) was actually lower than the
	Swiss AIR (23 \%) due to significantly more fountain water runoff. Although the uncertainties due to model
	parameters and fountain were significant, the model achieved a high correlation ($r^2 > 0.9$) with the UAV ice
	volume observations for two AIRs built under radically different climates.
