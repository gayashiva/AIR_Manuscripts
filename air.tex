...
\toprule
\textbf{Surface parameters} & \textbf{Range (Step)} & \textbf{Initial} & \textbf{CH21} & \textbf{IN21} & \textbf{CH20} \\\midrule
Ice Emissivity ($\epsilon_{ice}$) & 0.95-0.99 (0.01)                    & 0.97        & 0.95  &  &  \\
Ice Albedo ($\alpha_{ice}$)       & 0.01-0.35 (0.05)                      & 0.15        & 0.24  &  &  \\
Snow Albedo ($\alpha_{snow})$     &  $\pm$ 5 \% (0.05)                    & 0.85        & 0.87  &  &  \\
Precipitation Temperature threshold ($T_{ppt}$) & $0-3\,\degree C$ (1) & $1\degree C$& $1\degree C$ &  &  \\
Albedo Decay Rate ($\tau$)        & $\pm$ 5 \% (0.5)                     & 10 days     & 10 days &  &  \\
Surface Roughness ($z_0$)         & $1-5\, mm$ (1)                     & $1\,mm$     & $1\,mm$ &  &  \\ 
Surface layer thickness ($\Delta x$)&$\pm$ 5 \% (0.5)                    & $20\,mm$    & $20\,mm$ &  &  \\\midrule 
\textbf{Fountain parameters} & &  & & &  \\\midrule
     Water temperature ($T_{water}$)   & $0-5\,\degree C$ (1)               & $1\degree C$&$1\degree C$  &  &  \\ 
