...
be categorised based on the fountain used and the location selected. According to Eqn.
...
period ends (starts) at the last fountain discharge event.
...
together with the freezing/melting energy flux. Fig.  \ref{fig:MEB} shows the daily thickness and energy balance
...
radius during the accumulation period. The variance of this surface area is quite low in the accumulation period since
the ice radius is initialised and bounded by the spray radius. So the thickness rate is uniformly scaled to
produce the corresponding ice volume during the accumulation period.
